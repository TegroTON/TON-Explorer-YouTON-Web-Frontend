<?php
   ...
   ?> 
<main class="main">
    <section class="section mt-0 mt-lg-5">
      <div class="container">
         <div class="row">
            <div class="col-lg-8">
               <div class="main-icon ml-0"><i class="fi-icon icon-edit"></i></div>
               <div class="mb-5">
               ...
               <div class="fs-4 fw-medium mb-3">INFORMATION WE COLLECT</div>
               <div class="mb-5">
                  <p>
               ...
               <div class="fs-4 fw-medium mb-3">HOW WE USE THE INFORMATION</div>
               <div class="mb-5">
                  <p>
               ...
               <div class="fs-4 fw-medium mb-3">LEGAL BASIS FOR PROCESSING YOUR PERSONAL INFORMATION</div>
               <div class="mb-5">
               ...
               <div class="fs-4 fw-medium mb-3">SHARING OF THE INFORMATION</div>
               <div class="mb-5">
               ...
               <div class="fs-4 fw-medium mb-3">CROSS-BORDER INFORMATION TRANSFER</div>
               <div class="mb-5">
                  <p>
               ...
               <div class="fs-4 fw-medium mb-3">YOUR RIGHTS</div>
               <div class="mb-5">
               ...
               <div class="fs-4 fw-medium mb-3">RETENTION PERIOD</div>
               <div class="mb-5">
               ...
               <div class="fs-4 fw-medium mb-3">SECURITY</div>
               <div class="mb-5">
               ...
               <div class="fs-4 fw-medium mb-3">THIRD PARTY SERVICES</div>
               <div class="mb-5">
               ...
               <div class="fs-4 fw-medium mb-3">CHANGES AND UPDATES TO PRIVACY POLICY</div>
               <div class="mb-5">
               ...
               <div class="fs-4 fw-medium mb-3">CONTACT INFORMATION</div>
               <div class="mb-5">
                  ...
                  <br>
                  E-mail: <a href="mailto:contact@Tonhold.com">contact@Tonhold.com</a>
               </div>
            </div>
         </div>
      </div>
